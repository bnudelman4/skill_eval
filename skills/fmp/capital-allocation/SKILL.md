...
## 2. Market Data
Get the current stock price, market cap, and shares outstanding for {TICKER} (see fmp_data_access.md Section 2 for how to source market data in your environment).
