...
- [ ] M1 — known-answer fixtures
- [ ] M2 — deterministic verifier (built + proven before any live run)
- [ ] M3 — headless skill invocation
- [ ] M4 — ground-truth sources & frozen snapshots
- [ ] M5 — harness, metrics, scorecard
